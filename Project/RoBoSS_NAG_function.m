...
titlle_name = sprintf('Confusion Matrix\nk=%g, r=%g, t=%g, m=%g, a=%g, b=%g, C=%g, meu=%g', k, r, t, m, a, b, C, mew);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   %%      Inputs of function
...
figure;
imagesc(C);
title(titlle_name,sprintf('Accuracy=%.2f%%',Accuracy));
% % title(sprintf('\n Accuracy=%.2f%%',Accuracy));
xlabel('Predicted Class');
ylabel('True Class');
set(gca, 'XTick', 1:2, 'XTickLabel', classNames, 'YTick', 1:2, 'YTickLabel', classNames);
colorbar;

% Add counts to the plot
text(1, 1, ['TN: ' num2str(tn)], 'HorizontalAlignment', 'center', 'VerticalAlignment', 'middle', 'Color', 'w');
text(2, 2, ['TP: ' num2str(tp)], 'HorizontalAlignment', 'center', 'VerticalAlignment', 'middle', 'Color', 'w');
text(2, 1, ['FN: ' num2str(fn)], 'HorizontalAlignment', 'center', 'VerticalAlignment', 'middle', 'Color', 'w');
text(1, 2, ['FP: ' num2str(fp)], 'HorizontalAlignment', 'center', 'VerticalAlignment', 'middle', 'Color', 'w');
